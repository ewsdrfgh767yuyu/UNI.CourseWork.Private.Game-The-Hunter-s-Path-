...
void HeroFactory::initializeTemplates()
{
    ...
    heroTemplates[HeroClass::WARRIOR] = {
        "Воин", "Могучий боец ближнего боя, специализирующийся на защите и мощных ударах", HeroClass::WARRIOR, ProgressionType::LEVEL_BASED, 120, 15, 5, 3, 2, 12, 0, AbilityType::CHARGE, {AbilityType::CHARGE, AbilityType::SHIELD_WALL, AbilityType::BERSERK, AbilityType::BATTLE_CRY}, false, 0.15};

    // ПАЛАДИН - защитник с лечением
    heroTemplates[HeroClass::PALADIN] = {
        "Паладин", "Святой воин, сочетающий защиту, лечение и поддержку союзников", HeroClass::PALADIN, ProgressionType::MASTERY, 130, 12, 8, 2, 2, 10, 0, AbilityType::HEALING_WAVE, {AbilityType::HEALING_WAVE, AbilityType::SHIELD_WALL, AbilityType::COMMAND, AbilityType::FROST_ARMOR}, false, 0.1};

    // ВАРВАР - берсерк с высоким уроном
    heroTemplates[HeroClass::BARBARIAN] = {
        "Варвар", "Дикий воин, черпающий силу из ярости и неистовства", HeroClass::BARBARIAN, ProgressionType::SACRIFICE, 110, 18, 3, 4, 3, 14, 0, AbilityType::BERSERK, {AbilityType::BERSERK, AbilityType::CHARGE, AbilityType::BATTLE_CRY, AbilityType::BLOOD_RITUAL}, false, 0.4 // Высокий разброс - может нанести очень много или почти ничего
    };

    // РАЗБОЙНИК - stealth и критические удары
    heroTemplates[HeroClass::ROGUE] = {
        "Разбойник", "Ловкий убийца, специализирующийся на скрытности и внезапных атаках", HeroClass::ROGUE, ProgressionType::SKILL_POINTS, 90, 14, 2, 3, 3, 16, 1, AbilityType::STEALTH, {AbilityType::STEALTH, AbilityType::SHADOW_STEP, AbilityType::POISON, AbilityType::INVISIBLE}, false, 0.25};

    // СЛЕДОПЫТ - дальний бой и мобильность
    heroTemplates[HeroClass::RANGER] = {
        "Следопыт", "Мастер лука и леса, сочетающий дальний бой с мобильностью", HeroClass::RANGER, ProgressionType::LEVEL_BASED, 100, 13, 3, 3, 2, 15, 2, AbilityType::NONE, {AbilityType::ARCANE_MISSILE, AbilityType::TELEPORT, AbilityType::COMMAND, AbilityType::HEAL}, false, 0.2};

    // МАГ - магический урон и контроль
    heroTemplates[HeroClass::MAGE] = {
        "Маг", "Повелитель магии, специализирующийся на заклинаниях и контроле поля боя", HeroClass::MAGE, ProgressionType::SKILL_POINTS, 80, 8, 1, 2, 2, 11, 3, AbilityType::ARCANE_MISSILE, {AbilityType::ARCANE_MISSILE, AbilityType::CHAIN_LIGHTNING, AbilityType::FLAME_BURST, AbilityType::TELEPORT}, false, 0.05 // Почти без разброса - маги стреляют точно
    };

    // КОЛДУН - демоническая магия и жертвы
    heroTemplates[HeroClass::WARLOCK] = {
        "Колдун", "Темный маг, черпающий силу из демонических сделок и жертв", HeroClass::WARLOCK, ProgressionType::SACRIFICE, 85, 10, 2, 3, 2, 13, 2, AbilityType::BLOOD_RITUAL, {AbilityType::BLOOD_RITUAL, AbilityType::LIFE_STEAL, AbilityType::FEAR, AbilityType::CHAIN_LIGHTNING}, false, 0.3};

    // ДРУИД - природная магия и трансформация
    heroTemplates[HeroClass::DRUID] = {
        "Друид", "Страж природы, владеющий магией земли и исцелением", HeroClass::DRUID, ProgressionType::TRANSCENDENCE, 105, 11, 4, 2, 2, 12, 1, AbilityType::REGENERATION, {AbilityType::REGENERATION, AbilityType::HEALING_WAVE, AbilityType::POISON, AbilityType::TELEPORT}, false};
