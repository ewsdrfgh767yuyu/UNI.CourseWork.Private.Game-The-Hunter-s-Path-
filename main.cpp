    ...
    while (window.isOpen())
    {
        ...
        if (currentState == GameState::CHARACTER_CONFIRMATION && selectedPresetIndex != static_cast<size_t>(-1)) {
            ...
            for (size_t i = 0; i < preset.heroes.size(); ++i) {
                ...
                characterConfirmationMenu.addText(statsStr, 16, sf::Vector2f(70, yPos), sf::Color::Magenta);
                yPos += 20;
                ...
                characterConfirmationMenu.addText(abilitiesStr, 16, sf::Vector2f(70, yPos), sf::Color::Cyan);
                yPos += 22;
                ...
                for (AbilityType abilityType : tmpl.availableAbilities) {
                    ...
                    characterConfirmationMenu.addText("  " + ability.name + ": " + ability.effect, 14, sf::Vector2f(70, yPos), sf::Color::Green);
                    yPos += 17;
                }
